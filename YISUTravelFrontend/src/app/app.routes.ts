...
export const routes: Routes = [
  ...
  {
    path: 'ueber-uns',
    loadComponent: () => import('./Dynamic/about-us/about-us-dashboard/about-us-dashboard.component')
      .then(m => m.AboutUsDashboardComponent),
    data: {
  ...
  {
    path: 'kontakt',
    loadComponent: () => import('./Dynamic/contact/contact-dashboard/contact-dashboard.component')
  ...
  {
    path: 'dienstleistung',
    loadComponent: () => import('./Dynamic/dienstleistung/dienstleistung-dashboard/dienstleistung-dashboard.component')
      .then(m => m.DienstleistungDashboardComponent),
    data: {
  ...
  {
    path: 'impressum',
    loadComponent: () => import('./Dynamic/impressum/impressum.component')
  ...
  },
  {
    ...
    loadComponent: () => import('./Dynamic/datenschutzerklaerung/datenschutzerklaerung.component')
      .then(m => m.DatenschutzerklaerungComponent),
    data: {
  ...
  {
    path: 'agb',
    loadComponent: () => import('./Dynamic/agb/agb.component')
  ...
  {
    path: 'startseite',
    loadComponent: () => import('./Dynamic/homepage/homepage-startseite/homepage-startseite.component')
      .then(m => m.HomepageStartseiteComponent),
    data: {
  ...
  {
    path: 'admin-login',
    loadComponent: () => import('./Dynamic/admin-section/admin-dashboard/admin-login/admin-login.component')
      .then(m => m.AdminLoginComponent)
  },
  {
    path: 'admin-dashboard',
    loadComponent: () => import('./Dynamic/admin-section/admin-dashboard/admin-dashboard.component')
  ...
  {
    path: 'admin-livechat',
    loadComponent: () => import('./Dynamic/admin-section/admin-livechat/admin-livechat.component')
      .then(m => m.AdminLivechatComponent)
  },
  {
    path: 'admin/buchungsliste',
    loadComponent: () => import('./Dynamic/admin-section/admin-dashboard/booking-list/booking-list.component')
      .then(m => m.BookingListComponent),
    canActivate: [adminGuard]
  },
  {
    path: 'admin/buchungsliste/:id',
    loadComponent: () => import('./Dynamic/admin-section/admin-dashboard/booking-list/booking-detail/booking-detail.component')
      .then(m => m.BookingDetailComponent),
    canActivate: [adminGuard]
  },
  {
    path: 'admin/chatbot-trainieren',
    loadComponent: () => import('./Dynamic/admin-section/admin-dashboard/chatbot-response-insert/chatbot-response-insert.component')
      .then(m => m.ChatbotResponseInsertComponent),
    canActivate: [adminGuard]
  },
  {
    path: 'profile',
    loadComponent: () => import('./Dynamic/profile-management/profile-management.component')
  ...
  {
    path: 'password-reset',
    loadComponent: () => import('./Dynamic/password-reset/password-reset.component')
      .then(m => m.PasswordResetComponent)
  },
  {
    path: 'kunden-registrierung',
    loadComponent: () => import('./Dynamic/customer-registration/customer-registration.component')
      .then(m => m.CustomerRegistrationComponent)
  },
  {
    path: 'customer-dashboard',
    loadComponent: () => import('./Dynamic/customer-dashboard/customer-dashboard.component')
  ...
  {
    path: 'termin-buchen',
    loadComponent: () => import('./Dynamic/homepage/homepage-contact/appointment-booking/appointment-booking.component')
  ...
  {
    path: 'buchung',
    loadComponent: () => import('./Dynamic/buchung/buchung.component')
      .then(m => m.BuchungComponent),
    data: {
